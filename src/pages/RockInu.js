...
const RockInu = () => {
  ...
  const onN2Image1Click = useCallback(() => {
    const anchor = document.querySelector("[data-scroll-to='n1Image']");
    if (anchor) {
      anchor.scrollIntoView({ block: "start", behavior: "smooth" });
    }
  ...
  return (
    <div className={styles.rockInu}>
      ...
      <a
        ...
        href="https://drive.google.com/file/d/1TNQe5g55-jhT3hRYLL8Yf6G5ORgt07w_/view?usp=drive_link"
        target="_blank"
      >
        WHITEPAPER
      </a>
      <a
        ...
        href="https://bscscan.com/token/0x03103dc7aa723d2420d6f0f605b639d5f4c5199b#tokenInfo"
        target="_blank"
      >
        BLOCK EXPLORER
      </a>
      ...
      <a
        ...
        href="https://t.me/+DOu_JzalqaZhNzY0"
        target="_blank"
      >
        Telegram
      </a>
      ...
      <a
        className={styles.x}
        href="https://www.x.com/rockinucoin"
        target="_blank"
      >
        X
      </a>
